 ...
 *
 * Real, tenant-scoped CSV/XLSX outcome ingestion. Intelligently maps
 ...
 *
 * Usage:
 *   node scripts/importOutcomeSpreadsheet.js --location=<id> --file=<path> [--dry-run]
 */
...
if (!LOCATION_ID || !FILE_PATH) { console.error('Provide --location=<id> --file=<path>'); process.exit(1); }
...
function parseDate(value) {
  ...
  if (typeof value === 'number') {
    // Real Excel serial date - XLSX gives us the JS Date via cellDates option instead where possible
